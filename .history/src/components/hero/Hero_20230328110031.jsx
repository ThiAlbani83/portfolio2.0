        ...
        <div id='home' className='w-full px-10 max-w-[1440px] mx-auto mt-10 md:mt-40 lg:mt-28 flex flex-col lg:flex-row gap-3 md:gap-0 items-center justify-center text-center'>
            <div className='w-full flex flex-col gap-5 md:gap-10'>
                ...
                <div className='text-xl md:text-2xl flex items-center justify-center gap-7'>
                    <a href="https://www.linkedin.com/in/thiago-albani"><AiOutlineLinkedin className='cursor-pointer hover:text-cyan-500 hover:scale-110' /></a>
                    <a href="https://github.com/ThiAlbani83"><AiOutlineGithub className='cursor-pointer hover:text-cyan-500 hover:scale-110' /></a>
                </div>
            </div>
