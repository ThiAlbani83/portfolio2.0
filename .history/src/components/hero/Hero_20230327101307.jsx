...
export default function Hero() {
    return (
        <div className='w-full px-10 max-w-[1440px] mx-auto mt-10 flex flex-col md:flex-row gap-3 md:gap-0 items-center justify-center text-center'>
            <div className='w-full flex flex-col gap-5'>
                <div className='flex flex-col gap-3'>
                    <h3 className='text-2xl md:text-3xl tracking-[3px]'>Olá, me chamo</h3>
                    <h1 className='text-4xl md:text-5xl text-cyan-500 tracking-[3px]'>Thiago Pereira</h1>
