            ...
            <div className='flex flex-col w-full max-w-[1440px] px-10 py-5 mt-5 lg:justify-between mx-auto items-center gap-5 justify-center'>
                <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex gap-3 items-center justify-center'>
                        ...
                        <a href=""><AiOutlineLinkedin className='text-xl hover:text-cyan-500' /></a>
                    </div>
                </div>
                <div>
                    <form className='flex flex-col gap-3 text-black' onSubmit={handleSubmit(onSubmit)}>
                        <input className='text-lg rounded-xl focus:ring-cyan-500 focus:ring-1' placeholder='Seu e-mail' type="email" id="email" {...register("email")} />
                        <textarea className='text-lg rounded-xl' placeholder='Sua mensagem' id="message" rows="3" {...register("message")} />
                        <button
