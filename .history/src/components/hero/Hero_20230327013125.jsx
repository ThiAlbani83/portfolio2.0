    ...
    return (
        <div className='w-full px-3 max-w-[1440px] mx-auto mt-10 flex flex-col gap-3'>
            ...
            <div className='text-xl flex items-center gap-3'>
                <AiOutlineLinkedin className='cursor-pointer hover:text-cyan-500' />
                <AiOutlineInstagram className='cursor-pointer hover:text-cyan-500' />
                <AiOutlineBehance className='cursor-pointer hover:text-cyan-500' />
