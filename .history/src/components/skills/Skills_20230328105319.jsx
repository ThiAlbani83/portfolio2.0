...
export default function Skills({ skills }) {
    ...
    return (
        <div id='skills' className='w-full flex flex-col items-center justify-center max-w-[1440px] mx-auto mt-20 lg:mt-40 px-10 text-center md:text-start gap-20'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 w-full gap-10'>
                {skills.map((val, index) => (
                    <div key={index} className='flex flex-col items-center justify-center gap-3'data-aos="fade-up" data-aos-duration="2000">
