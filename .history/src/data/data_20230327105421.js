...
export const aboutMe = {
    ...
    Meus projetos são feitos em HTML, CSS (Tailwindcss, Bootstrap ou CSS puro) e Reactjs. Sempre utilizando as melhores bibliotecas de componentes que melhor se encaixam a cada projeto`
}