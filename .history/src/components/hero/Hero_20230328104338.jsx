...
export default function Hero({ hero: { title, name, description, job, img } }) {
    ...
    return (
        <div id='home' className='w-full px-10 max-w-[1440px] mx-auto mt-10 md:mt-40 lg:mt-10 flex flex-col lg:flex-row gap-3 md:gap-0 items-center justify-center text-center'>
            <div className='w-full flex flex-col gap-5 md:gap-10'>
                <div className='flex flex-col gap-3 md:gap-10' data-aos="fade-up" data-aos-duration="1000" >
            ...
            <div className='w-full mt-10 flex items-center justify-center' data-aos="fade-right" data-aos-duration="3000">
