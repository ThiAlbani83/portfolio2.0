...
export default function PortfolioCard({img, title, liveLink}) {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 items-center justify-center w-full cursor-pointer'>
        {portfolioCard.map((val, index) => (
            <div className='flex flex-col gap-2 w-full rounded-lg border-gray-200 shadow-md shadow-cyan-800'>
