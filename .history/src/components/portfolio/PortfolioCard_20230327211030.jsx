    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 items-center justify-center w-full'>
            {portfolioCard.map((val, index) => (
                <a href={val.liveLink}><div className='flex flex-col gap-2 w-full rounded-lg border-gray-200 shadow-md shadow-cyan-800 
            cursor-pointer hover:shadow-gray-300 hover:scale-105 duration-500'>
