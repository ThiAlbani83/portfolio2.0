...
export default function Skills({ skills }) {
    ...
    return (
        <div className='w-full flex flex-col items-center justify-center md:items-start max-w-[1440px] mx-auto mt-20 lg:mt-40 px-10 text-center md:text-start gap-20'>
