  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-20 items-center justify-center w-full'>
        {portfolioCard.map((val, index) => (
            <div className='flex flex-col gap-2 w-full border-[0.4px] rounded-lg border-gray-200 items-center justify-center'>
                <img src={val.img} alt="image/portfolio" className='w-full rounded-lg'/>
