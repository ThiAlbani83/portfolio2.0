...
export default function Hero({ hero: { title, name, description, job, img } }) {
    ...
    return (
        <div id='home' className='w-full px-10 max-w-[1440px] mx-auto mt-10 md:mt-40 lg:mt-40 flex flex-col lg:flex-row gap-3 md:gap-0 items-center justify-center text-center'>
