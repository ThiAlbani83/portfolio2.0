...
const Navbar = () => {
    ...
    return (
        <div className='w-full flex justify-between px-10 py-6 items-center max-w-[1440px] mx-auto'>
            ...
            <ul className='md:flex fixed w-full h-full items-center justify-center gap-12 peer hidden'>
                <li className='textsm'>Home</li>
                <li className='textsm'>Sobre</li>
                <li className='textsm'>Habilidades</li>
                <li className='textsm'>Portfolio</li>
                <li className='textsm'>Contato</li>
            </ul>
            <GiHamburgerMenu onClick={handleNav} className='z-20 text-white cursor-pointer hover:text-cyan-500 md:hidden' size={25} />
